			...
			if ( ! empty( $_POST['codepeople_promote_banner_plugin'] ) ) {
				...
				if ( ! empty( $codepeople_promote_banner_plugins[ $_codepeople_promote_banner_plugin ] ) ) {
					...
					if (
						...
						print '<script>document.location.href="' . str_replace( '&amp;', '&', esc_js( $codepeople_promote_banner_plugins[ $_codepeople_promote_banner_plugin ]['plugin_url'] ) ) // phpcs:ignore WordPress.Security.EscapeOutput
						. '";</script>';
					}
				}
			}
